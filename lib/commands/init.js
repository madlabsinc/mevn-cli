...
let showTables = () => {
  ...
  serverCommands.push({
    'mevn create:model': 'To create models file'
  }, {
    'mevn create:route' : 'To create routes file'
  }, {
    'mevn create:controller': 'To create controllers file'
  }, {
    'mevn create:component': 'To create components file'
  },{
    'mevn add:package': 'To add a package to the project'
  }, {
    'mevn create:config': 'To create config file'
  });
  ...
  generalCommands.push({
    'mevn version': 'Shows the current version and additional info'
  }, {
    ...
    'mevn codesplit <component_name>': 'To lazy load components as required'
  }, {

    ...
    inquirer.prompt([{
      ...
      if (answers.initial + '' == 'basic') {
        ...
        setTimeout(() =>{
          ...
          serverCommands.push({
            'mevn-cli make:models': 'To create models file'  
          }, {
            'mevn-cli make:routes' : 'To create routes file'
          }, {
            'mevn-cli make:controllers': 'To create controllers file'
          }, {
            'mevn-cli make:config': 'To create config file'
          });
